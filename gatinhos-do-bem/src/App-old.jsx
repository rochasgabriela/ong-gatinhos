      ...
      <section id="gatinhos" className="py-20 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {kittens.map((kitten) => (
              <div key={kitten.id} className="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2">
                <div className="aspect-square overflow-hidden">
                  <img 
                    src={`https://placekitten.com/400/400?random=${kitten.id}`}
                    alt={kitten.name}
                    className="w-full h-full object-cover hover:scale-110 transition-transform duration-300"
                  />
                </div>
                <div className="p-6">
                  <h3 className="text-2xl font-bold text-gray-800 mb-2">{kitten.name}</h3>
                  <p className="text-pink-600 font-semibold mb-2">{kitten.age}</p>
                  <p className="text-gray-600 mb-4">{kitten.description}</p>
              ...
              <div key={testimonial.id} className="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-500">Adotou {testimonial.kitten}</p>
                  </div>
                </div>
              </div>
            ))}
